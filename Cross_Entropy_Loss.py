...
def my_BCE(o, t):
    return -torch.sum(torch.log(o) * t + torch.log(1 - o) * (1 - t)) / len(o)


def my_BCE2(o, t):
    return -torch.sum(torch.log(o) * t) / len(o)
...
# target = torch.tensor([[0, 1], [1, 0], [1, 0]], dtype=torch.float32)
# target_1 = torch.LongTensor([1, 0, 0])
# print("手搓二分类交叉熵为{}".format(my_BCE2(output, target)))
# BCE_loss2 = torch.nn.BCELoss()
# BCE_loss2 = torch.nn.CrossEntropyLoss()
# print("torch.nn.BCELoss()计算二分类交叉熵为{}".format(BCE_loss2(output, target_1)))
